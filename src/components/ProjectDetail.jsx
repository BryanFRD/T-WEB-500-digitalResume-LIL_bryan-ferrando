...
const ProjectDetail = ({project}) => {
  return (
    <div className='group shadow-lg mx-auto rounded-md overflow-hidden bg-backgroundsec h-min border-backgroundsec w-56 lg:w-64 max-h-64'>
      <div className='relative'>
        ...
        <img className='md:w-56 lg:w-64' src={project.img ? project.img : placeholder} alt={`${project.name} image`} />
